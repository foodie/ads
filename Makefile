...
DECRYPTER_PATH=./include/plugins/decrypter
...
DECRYPTER_OBJ:=$(patsubst %.cpp,%.o, $(wildcard ${DECRYPTER_PATH}/*.cpp))
...
mads: src/ads_conf.o src/ads_hash.o src/ads_data.o src/ads_func.o src/ads_thread.o \
     ...
     $(CONTROLLER_OBJ) $(EXCHANGE_OBJ) $(CRONTAB_OBJ) $(DECRYPTER_OBJ) 
...
clean:
	rm -rf src/*.o ${UTIL_PATH}/*.o mads \
		...
		${CONTROLLER_PATH}/*.o ${EXCHANGE_PATH}/*.o ${CRONTAB_PATH}/*.o ${DECRYPTER_PATH}/*.o
