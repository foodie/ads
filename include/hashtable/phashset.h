#ifndef  __PHASHSET_H_
#define  __PHASHSET_H_
...
template <class _Key, /*作为hashkey的类型*/
		...
		>
class phashset : public phashtable<_Key, _Key, _HashFun, _Equl, 
	lib::param_select<_Key>, _InnerAlloc>
{
public:
	typedef phashset<_Key, _HashFun, _Equl, _InnerAlloc> _Self;
	typedef phashtable<_Key, _Key, _HashFun, _Equl, lib::param_select<_Key>, _InnerAlloc> _Base;
